...
<head>
    ...
    <title>Administrasi Kategori</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="administrasi_Kategori.php">Welcome <?php echo $user ?></a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Database Kategori</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Isi Kategori</li>
                    </ol>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="fungsi.php">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="jumlahart" value="<?= $jumlah?>"
                                                                        placeholder="Masukkan jumlah artikel!">
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-primary"
                                                                        name="ubahkategori">Simpan Data</button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="fungsi.php">
                                                                ...
                                                                <span class="text-danger"><?= $kategori?> - <?= $jumlah?></span>
                                                                </h5>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="fungsi.php">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Jumlah Artikel</label>
                                                    <input type="text" class="form-control" name="jumlahart"
                                                        placeholder="Masukkan jumlah artikel!">
                                                </div>
                                                <div class="modal-footer">
                                                        <button type="submit" class="btn btn-primary"
                                                        name="tambahdatakategori">Simpan</button>
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Tutup</button>
                                                </div>
